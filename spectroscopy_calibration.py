...
fn.plotting3(const_i_data['timestamp'], const_i_data['photodiode'], const_i_data['volt_piezo']/10, const_i_data['volt_ld'], 'time', 'pd', 'piezo/10', 'ld', 'constant diode current, modulated piezo position', 'figures_calibration/time_constdiode.pdf', save = True)
fn.plotting3(const_piezo_data['timestamp'], const_piezo_data['photodiode'], const_piezo_data['volt_piezo']/10, const_piezo_data['volt_ld'], 'time', 'pd', 'piezo/10', 'ld', 'constant piezo current, modulated diode', 'figures_calibration/time_constpiezo.pdf', save = True)
fn.plotting3(spec_data['timestamp'], spec_data['photodiode'], spec_data['volt_piezo']/10, spec_data['volt_ld'], 'time', 'pd', 'piezo/10', 'ld', 'spectroscopy', 'figures_calibration/time_spec.pdf', save = True)
...
const_i_coeff1, const_i_coeff2 = fn.plot_fits(const_i_peaks['piezo_peaks'], const_i_peaks['freq'], 'piezo_peaks', 'freq', 'Constant diode current, modulated piezo position', "figures_calibration/fit_constdiode.pdf", save=True)
const_piezo_coeff1, const_piezo_coeff2 =fn.plot_fits(const_piezo_peaks['ld_peaks'], const_piezo_peaks['freq'], 'ld_peaks', 'freq', 'constant piezo position, modulated diode current', "figures_calibration/fit_constpiezo.pdf", save=True)

t_const_i_coeff1, t_const_i_coeff2 = fn.plot_fits(const_i_peaks['timestamp'], const_i_peaks['freq'], 'time', 'freq', 'Fixed Piezo, modulated diode current: time calib', "figures_calibration/timefit_constdiode.pdf", save=True)
t_const_piezo_coeff1, t_const_piezo_coeff2 = fn.plot_fits(const_piezo_peaks['timestamp'], const_piezo_peaks['freq'], 'time', 'freq', 'Fixed diode current, modulated piezo: time calib', "figures_calibration/timefit_constpiezo.pdf", save=True)
t_spec_coeff1, t_spec_coeff2 = fn.plot_fits(spec_peaks['timestamp'], spec_peaks['freq'], 'time', 'freq', 'Full transitions spectroscopy: time calib', "figures_calibration/timefit_spec.pdf", save=True)

#frequency conversion

#quadratic: THIS IS WRONG
...
#linear:
const_i_freq = const_i_coeff1[0] * const_i_data['volt_piezo'] + const_i_coeff1[1]
const_piezo_freq = const_piezo_coeff1[0] * const_piezo_data['volt_ld']+ const_piezo_coeff1[1]
spec_freq = t_spec_coeff1[0] * spec_data['timestamp']+ t_spec_coeff1[1]

#plot data vs frequencies
fn.plotting(const_i_freq, const_i_data['photodiode'],'calibrated frequency', 'signal at photodiode', 'spectroscopy of Rb, \n constant diode current, modulated piezo position', "figures_calibration/spec_constdiode.pdf", save=True)
fn.plotting(const_piezo_freq, const_piezo_data['photodiode'], 'calibrated frequency', 'signal at photodiode', 'spectroscopy of Rb, \n constant piezo position, modulated diode current', "figures_calibration/spec_constpiezo.pdf", save=True)
fn.plotting(spec_freq, spec_data['photodiode'], 'calibrated frequency', 'spec', 'everything modulated', "figures_calibration/spec_total_spec.pdf", save=True)
